...
########################################
### Get CASRN from CompTox Dashboard for exposure data
########################################
...
# Save the results as "CCD-Batch-Search.csv"
...
places <- read_csv("data-raw/PLACES__County_Data__GIS_Friendly_Format___2020_release.csv",
                   show_col_types = FALSE)
